...
namespace tc_project::map_renderer {
    ...
    public:
        ...
        std::vector<svg::Text> StopsTextRender(const std::vector<const Stop*>& stops) const;
        std::vector<svg::Polyline> BusesLineRender(const std::vector<const Bus*>& buses) const;
